    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarweb">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a href="{{url('/')}}" class="nav-link active text-white">Home</a>
                </li>
                <li class="nav-item">
                    <a href="{{url('tampiladmin')}}" class="nav-link text-white">Data admin</a>
                </li>
                <li class="nav-item">
                    <a href="{{url('tampilvehicle')}}" class="nav-link text-white">Data Parkiran</a>
                </li>
            </ul>
